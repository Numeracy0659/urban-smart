...
docker exec cloud-phone /opt/android-sdk/cmdline-tools/latest/bin/adb -s emulator-5555 shell pm list packages > /tmp/cloud-phone-backup/packages.txt 2>/dev/null || true
