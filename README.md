# Cloud Android Phone v2.0

Full Android phone in your browser — on-demand, secure, ephemeral, zero cost.

## Features
- Android 14 (API 34) with Pixel 6 profile
- ARM app support via libndk_translation
- ws-scrcpy browser streaming (H.264, 60fps)
- NPort secure HTTPS tunnel
- Root + Magisk + PICO GAPPS
- Session backup/restore
- GitHub Actions + GitLab CI support

## Deploy
1. Push to GitHub
2. Actions tab → Run workflow → Start
...
git add -A
git commit -m "feat: Cloud Android Phone v2.0"
